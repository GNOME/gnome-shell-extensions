...
class WorkspaceIndicator extends PanelMenu.Button {
    constructor() {
        ...
        let workspaceManager = global.worskpace_manager;
    ...
    _updateIndicator() {
        ...
        this._currentWorkspace = global.get_active_workspace().index();
    ...
    _onScrollEvent(actor, event) {
        ...
        let newIndex = global.get_active_workspace().index() + diff;
